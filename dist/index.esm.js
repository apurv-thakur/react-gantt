import React, { createContext, createRef, useState, useRef, useCallback, useContext, useMemo, useEffect, useImperativeHandle } from 'react';
...
var GanttStore = /*#__PURE__*/function () {
  function GanttStore(_ref) {
    ...
    this.width = 1320;
    this.height = 418;
    var sightConfig = viewTypeList[0];
  ...
  _createClass(GanttStore, [{
    ...
    value: function switchSight(type) {
      var target = find_1(viewTypeList, {
        type: type
      });
...
var css_248z$c = ".gantt-selection-indicator {\n  position: absolute;\n  width: 100%;\n  background: rgba(0, 0, 0, 0.04);\n  pointer-events: none;\n  z-index: 10;\n}\n";
...
var TaskBar = function TaskBar(_ref) {
  ...
  }, getDateWidth(translateX + width + moveCalc, translateX), " day(s)"), (stepGesture === 'moving' || allowDrag || alwaysShowTaskBar) && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
...
var css_248z$6 = ".gantt-group-bar {\n  position: absolute;\n  top: 0;\n  left: 0;\n  display: flex;\n}\n.gantt-group-bar .gantt-bar {\n  position: relative;\n  top: -3px;\n}\n";
...
var css_248z$3 = ".task-dependency-line {\n  z-index: -1;\n}\n.task-dependency-line .line {\n  stroke: #f87872;\n}\n";
...
var Dependence = function Dependence(_ref) {
  ...
  return /*#__PURE__*/React.createElement("g", {
    stroke: '#f87872',
    className: css_248z$3['task-dependency-line']
  }, /*#__PURE__*/React.createElement("path", {
    className: css_248z$3.line,
